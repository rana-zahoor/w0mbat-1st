...
foreach($GLOBALS['admin-pages'] as $pg=>$icon){
	$active = ($GLOBALS['file']==$pg || (array_key_exists($GLOBALS['file'],$sub_pages) && $sub_pages[$GLOBALS['file']] == $pg))?'active':'';
...
?>
        ...
        <div class="col-md-10" style="background:#d5d5d5;">
        	<?php require(ADMIN_DIR.'/'.$GLOBALS['file'].'.php'); ?>
        </div>
